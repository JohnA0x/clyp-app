...
export default function SwapConfirmation({amount, usdAmount, screenName, source, destination, date, txid, status, fee, swapCoin1, swapCoin2 }) {
  const navigation = useNavigation()
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image style={styles.swapImageContainer} source={{uri: swapCoin1}}/>
        <Ionicons name='swap-horizontal' size={30} style={styles.swapIcon}/>
        <Image style={styles.swapImageContainer2} source={{uri: swapCoin2}}/> 
       </View>
